...

{
    ...
    if (arity == 2) {
        asdl_expr_seq *elts = (asdl_expr_seq *)_PyPegen_singleton_seq(p, _PyAST_Name(_PyPegen_new_identifier(p, "_dollar_item"), Store, 1, 0, 1, 0, arena));
        elts = (asdl_expr_seq *)_PyPegen_seq_append_to_end(p, (asdl_seq *)elts, _PyAST_Name(_PyPegen_new_identifier(p, "_dollar_item_2"), Store, 1, 0, 1, 0, arena));
        return _PyAST_Tuple(elts, Store, 1, 0, 1, 0, arena);
    }
    asdl_expr_seq *elts = (asdl_expr_seq *)_PyPegen_singleton_seq(p, _PyAST_Name(_PyPegen_new_identifier(p, "_dollar_item"), Store, 1, 0, 1, 0, arena));
    elts = (asdl_expr_seq *)_PyPegen_seq_append_to_end(p, (asdl_seq *)elts, _PyAST_Name(_PyPegen_new_identifier(p, "_dollar_item_2"), Store, 1, 0, 1, 0, arena));
    elts = (asdl_expr_seq *)_PyPegen_seq_append_to_end(p, (asdl_seq *)elts, _PyAST_Name(_PyPegen_new_identifier(p, "_dollar_item_3"), Store, 1, 0, 1, 0, arena));
    return _PyAST_Tuple(elts, Store, 1, 0, 1, 0, arena);
}
