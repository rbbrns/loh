...
static PyObject *
builtin__loh_deepcopy(PyObject *self, PyObject *obj)
{
    PyObject *copy_mod = PyImport_ImportModule("copy");
    if (copy_mod == NULL) {
        return NULL;
    }
    PyObject *deepcopy_func = PyObject_GetAttrString(copy_mod, "deepcopy");
    Py_DECREF(copy_mod);
    if (deepcopy_func == NULL) {
        return NULL;
    }
    PyObject *res = PyObject_CallOneArg(deepcopy_func, obj);
...
static PyMethodDef builtin_methods[] = {
    {"_loh_deepcopy", (PyCFunction)builtin__loh_deepcopy, METH_O, NULL},
