...
"""
        scope = {}
        exec(code, {}, scope)
        self.assertEqual(scope["deep_dict"], {"items": [1, 2, 3], "meta": {"owner": "Alice"}})
        self.assertEqual(scope["deep_list"], [1, 2, 3])

    def test_implicit_dict_unpacking(self):
        code = """
app_config = {
    "env": "prod",
    "port": 8080,
...
"""
        scope = {}
        exec(code, {}, scope)
        self.assertEqual(scope["app_config"], {
            "env": "prod",
            "port": 8080,
